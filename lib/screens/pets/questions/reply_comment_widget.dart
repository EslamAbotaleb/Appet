...
class ReplayOnCommentWidget extends StatefulWidget {
  @override
  _ReplayOnCommentWidgetState createState() => _ReplayOnCommentWidgetState();
}

class _ReplayOnCommentWidgetState extends State<ReplayOnCommentWidget> {
              ...
              child: FlatButton(
                onPressed: () {
                  if (commentController.text.length > 0) {
                    ...
                    showToast("Please enter comment", false);
                  }
                },
                color: ColorUtils.appColor,
